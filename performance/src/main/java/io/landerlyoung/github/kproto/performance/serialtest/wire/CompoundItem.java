...
public final class CompoundItem extends Message<CompoundItem, CompoundItem.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "io.landerlyoung.github.kproto.performance.serialtest.wire.TextItem#ADAPTER"
  )
  public final TextItem text;

  @WireField(
      tag = 2,
      adapter = "io.landerlyoung.github.kproto.performance.serialtest.wire.PictureItem#ADAPTER"
  )
