...
public final class Message extends com.squareup.wire.Message<Message, Message.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "io.landerlyoung.github.kproto.performance.serialtest.wire.ItemType#ADAPTER"
  )
  public final ItemType itemType;

  @WireField(
      tag = 2,
      adapter = "io.landerlyoung.github.kproto.performance.serialtest.wire.CompoundItem#ADAPTER",
